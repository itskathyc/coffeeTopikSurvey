...
export const UI_STRINGS: Record<Language, any> = {
    ko: {
        ...
        start: '시작하기',
        thankYou: '감사합니다!',
        phoneRequest: '전화번호 혹은 연락이 가능한 인스타그램 ID 를 남겨주세요 !\n추첨을 통해 올리브영 상품권 1만원권을 10분께 드립니다!',
        submit: '제출하기',
        adminTitle: '설문 결과',
        back: '뒤로',
        loading: '로딩 중...',
        phonePlaceholder: '전화번호 (010-0000-0000)',
        instaPlaceholder: '인스타그램 ID',
    },
    en: {
        selectLanguage: 'Select Language',
        next: 'Next',
        start: 'Start',
        thankYou: 'Thank You!',
        phoneRequest: 'Please leave your phone number or Instagram ID!\n10 winners will receive a 10,000 KRW Olive Young gift card through a lucky draw!',
        submit: 'Submit',
        adminTitle: 'Survey Results',
        back: 'Back',
        loading: 'Loading...',
        phonePlaceholder: 'Phone Number',
        instaPlaceholder: 'Instagram ID',
    },
    zh: {
        selectLanguage: '选择语言',
        next: '下一步',
        start: '开始',
        thankYou: '谢谢！',
        phoneRequest: '请留下您的电话号码或 Instagram ID！\n我们将通过抽奖向 10 位获奖者赠送价值 10,000 韩元的 Olive Young 礼品卡！',
        submit: '提交',
        adminTitle: '调查结果',
        back: '返回',
        loading: '加载中...',
    ...
    vi: {
        ...
        start: 'Bắt đầu',
        thankYou: 'Cảm ơn!',
        phoneRequest: 'Vui lòng để lại số điện thoại hoặc ID Instagram của bạn!\n10 người may mắn sẽ nhận được thẻ quà tặng Olive Young trị giá 10.000 KRW thông qua hình thức bốc thăm!',
        submit: 'Gửi',
        adminTitle: 'Kết quả khảo sát',
        back: 'Quay lại',
        loading: 'Đang tải...',
        phonePlaceholder: 'Số điện thoại',
        instaPlaceholder: 'ID Instagram',
    },
    id: {
        ...
        phoneRequest: 'Silakan tinggalkan nomor telepon atau ID Instagram Anda!\n10 pemenang akan menerima kartu hadiah Olive Young senilai 10.000 KRW melalui undian berhadiah!',
        submit: 'Kirim',
